...
class PDF extends FPDF
{
	...
	$header = array(
		...
		array("label"=>"Pekerjaan", "length"=>50, "align"=>"C"),
		array("label"=>"Jumlah (Orang)", "length"=>28, "align"=>"C"),
		array("label"=>"Jam Kerja/Hari", "length"=>28, "align"=>"C"),
		array("label"=>"Biaya/Orang", "length"=>26, "align"=>"C"),
	);
